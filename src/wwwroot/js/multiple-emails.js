(function( $ ){
	...
	$.fn.multiple_emails = function(options) {
		...
		{
			deleteIconHTML = '<a href="#" class="multiple_emails-close" title="Remove"><span class="glyphicon glyphicon-remove bi bi-x-circle" style="margin-right:4px; color:#888"></span></a>';
		}
		...
		return this.each(function() {
			...
			var $input = $('<input type="text" class="multiple_emails-input text-left" placeholder="' + settings.placeholder +'"/>').on('keyup', function(e) { // input
				...
				// JPW added to prevent form submit on enter in input
